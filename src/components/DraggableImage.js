...
class DraggableImage {
  constructor(image, mainImg) {
    this.name = image.name;
    this.img = image;
    this.canv = document.createElement('canvas');
    this.canv.width = mainImg.width;
    this.canv.height = mainImg.height;
    ...
    this.absoluteCenter = this.center;
  ...
  generate() {              // generates canvas to return to client
    ...
    if (this.radian) {
      ...
      c.width = this.canv.width;
      c.height = this.canv.height;
